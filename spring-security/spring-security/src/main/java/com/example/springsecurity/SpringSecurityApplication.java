...
public class SpringSecurityApplication implements  CommandLineRunner{
	...
	CommandLineRunner run(UserService userService){
		return args -> {
			...
			userService.saveUser(new User(null,"santhosh","santhu","Struggle",new ArrayList<>()));
			userService.saveUser(new User(null,"manikanta","mani","Struggle",new ArrayList<>()));
			userService.saveUser(new User(null,"saisri","sai","Struggle",new ArrayList<>()));
			userService.saveUser(new User(null,"Ramadevi","rama","s",new ArrayList<>()));
